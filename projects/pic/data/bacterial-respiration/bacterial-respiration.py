...
def bacterial_respiration_discovery(noise_level):
    data_file = os.path.join(os.path.dirname(__file__), 'bacterial-respiration.npz')
    ...
    epde_search_obj.fit(data=[x, y], variable_names=['x', 'y'], max_deriv_order=(1,),
                        equation_terms_max_number=7, data_fun_pow=1, additional_tokens=[],
...
if __name__ == "__main__":
    ...
    bacterial_respiration_discovery(0)
