...
from tests.functional.scenarios.lv.lv import LotkaVolterraTest
...
def test_lv(operator_name, params, runtime_options):
    ...
    scenario = LotkaVolterraTest(noise_level=0)
